...
const messages = defineMessages({
  detailsTitle: {
    ...
    id: 'admin/pages.admin.email.pages.form.details.title',
  },
  fieldLogin: {
    defaultMessage: 'Requires authentication',
    id: 'admin/pages.admin.email.pages.form.field.login',
  },
  fieldPath: {
    defaultMessage: 'URL',
  ...
  fieldTitle: {
    ...
    id: 'admin/pages.admin.email.pages.form.field.title',
  },
})
...
const Form: React.FunctionComponent<Props> = ({
  ...
  return (
    <form onSubmit={onSave}>
      <SectionTitle textId="admin/pages.admin.email.pages.form.details.title" />
      <Input
